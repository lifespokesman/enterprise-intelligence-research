...
> 目标：建立经典组织理论坐标系，再用 AI 作为新主体去做压力测试。
>
> 本文件是理论坐标，不是强制课程或当前顺序；当前论文与覆盖缺口见 [reading-list](reading-list.md)，执行进度见 [NOW](../NOW.md)。

## M 模块与 Q 问题如何对应

以下是本项目的学习导航，不是各理论作者对 AI 的结论。一个问题可以借多个理论，一个理论也可解释多个问题。

| 模块 | 在研究中承担什么 | 主要连接 | 当前理解检查点 |
|---|---|---|---|
| M1 组织为何存在 | 理解有限理性、市场与层级、交易成本 | Q1 / Q4 | 能解释为什么不把所有任务交给一个主体或全部外包 |
| M2 分工、协调与可行性 | 理解任务依赖、整合、信息处理与组织控制 | Q1 / Q3 | 能区别收益来源、工作安排与协调成本；P-001 只覆盖其中一部分 |
| M3 权力、委托与责任 | 理解委托、授权、激励与承担后果的关系 | Q1 / Q2 / Q4 | 能区分更有能力、获得权限、承担责任三个命题 |
| M4 组织学习 | 理解经验、惯例、记忆、探索与利用 | Q5 | 能解释局部行为变化如何保留并影响组织后续表现 |
| M5 AI 主体 | 用新主体属性检验前四模块 | 横跨 Q1–Q5，逐篇核对 | 说明哪个假设被改变，或只是出现了新实现机制 |
| M6 企业智能综合 | 比较前面理论与公开证据的共同解释和冲突 | Q1–Q5 综合 | 每项工程或治理推论能追溯到问题与证据，并标出空白 |

当前 P-001 / P-002 / P-004 / P-005 主要集中在 M2 与 M5 的相邻研究脉络；有论文入口不等于该模块已学完。M1、M3、M4 的基础只在出现明确缺口时补充；M6 不用于抢先形成“最终架构”。
...
- AI 没有传统自利动机，但也没有传统担责能力，Agency Problem 如何变化？
- Agent Owner、Producer、User、Business Owner 应如何分责？
- Policy / Trace / Evidence / Approval 是否构成新的责任传递机制？
...
- Agent Trace 是否成为新的组织学习原料？
- Agent Learning 与 Organizational Learning 有什么区别？
- AI 参与生成 Knowledge / Rule / Skill / World Model 后，谁拥有最终发布权？
...
2. 原理论的关键假设是什么？
3. AI 改变了哪个假设？
4. 它提出的是新组织问题，还是旧问题的新机制？

---

## M6｜重新推导 Enterprise Intelligence
...
`Organization Theory → Enterprise Intelligence → AI-era Organization Design → Intelligent Subject Governance / Engineering`
