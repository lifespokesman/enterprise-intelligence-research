...
研究卡首先要帮助用户**真正理解和吸收论文**，其次才帮助仓库更新理论框架。

用户可能不会完整阅读英文论文，因此 AI 不能直接从原文跳到 Q1-Q5 / JUDGMENTS。否则用户只会得到 AI 的二次结论，而没有作者原始论证、事实、图表、例子和边界，难以形成自己的判断。

固定采用三层阅读结构：

`Part A 原文事实压缩 → Part B 七问研究映射 → Part C 人类吸收层`

### 9.2 Part A｜Source Facts｜原文事实压缩

在使用任何现有理论框架之前，先尽量忠实恢复：
...
- **原文事实**：文章结构、研究范围、图表、定义、例子、方法；
- **作者观点**：作者明确提出的判断或 conjecture；
- **引用研究**：作者借前人研究支持的机制/证据；
- **我们的推论**：从当前 Enterprise Intelligence 框架进一步得出的解释。

Part A 中不得为了适配本项目而补入作者没有讨论的 Ontology、Agent Governance、Capability Network 等内容。

英文材料要转成容易理解的中文，但保留关键英文术语，让用户能与原文对应。

### 9.3 Part B｜Research Interpretation｜七问
...
### 9.4 Part C｜Human Takeaways｜吸收层

最后再压缩成适合人长期记忆的少量内容：

- 3–5 个必须掌握的作者概念；
- 2–3 条长期记忆；
- 哪个当前 Judgment 被支持/挑战/修改；
- 哪个问题需要下一篇论文继续验证；
- 下一步阅读动作。
...
如果论文的原始问题与当前框架不匹配，应明确记录“不匹配”或“新现象”，而不是强行归类。
